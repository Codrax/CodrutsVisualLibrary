...
procedure Register;
begin
  RegisterComponents('Codrut Components',[CImage]);
end;
...
begin
  if Picture.Graphic is TGIFImage then
    begin
      ...
      //(Picture.Graphic as TGIFImage).AnimateLoop := glEnabled;
    end;
end;
            ...
            begin
              ...
              if FOpacity = 255 then
                for I := 0 to High(Rects) do
                  StretchDraw(Rects[I], Picture.Graphic)
              else
                for I := 0 to High(Rects) do
                ...
                begin
                  ...
                  if FOpacity = 255 then
                    for I := 0 to High(Rects) do
                      DrawHighQuality(Rects[I], Picture.Graphic, 255, false)
                  else
                    for I := 0 to High(Rects) do
